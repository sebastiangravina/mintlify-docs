...
title:  How to set up custom domains in Release0 to personalize your chatbot agent URL
icon: globe
...
However, you can also use your own custom domain for your agents. Check out our [pricing page](https://release0.com/pricing) for details about custom domian limits per plan.
