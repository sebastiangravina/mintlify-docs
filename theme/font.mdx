---
sidebarTitle: Font
title: How to customize the font in Release0 to match your chatbot’s agent branding
icon: font
description: Learn how to customize fonts for your Release0 agent, including Google Fonts and custom options. This guide provides step-by-step instructions to change the font of your chatbot agent, including how to import custom fonts and define the @font-face rule.
---
