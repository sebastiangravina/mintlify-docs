...
To integrate your bot with WhatsApp:

1. Go to the **Share** tab in your bot editor.
...
<AccordionGroup>
  <Accordion title="How many WhatsApp numbers can I use?">
    You can integrate as many numbers as you'd like. Keep in mind that Release0 does not provide those numbers. We work as a "Bring your own Meta application" and we give you clear instructions on [how to set up your Meta app](/help/deploy/whatsapp/create-meta-app).
  </Accordion>
