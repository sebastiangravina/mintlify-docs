...
1. All your requests need to be authenticated with an API token. [See instructions](/help/api-reference/authentication).
...
2. To send replies, send POST requests to `https://release0.com/api/v1/sessions/<session ID>/continueChat`  
   ...
   Check out the [Start chat API reference](../../api-reference/chat/start-chat.mdx) for more information.
