...
In this example, clicking the specified buttons will open the agent popup. However, you can replace `agent.open()` with any other command supported by the [Java library commands](/help/deploy/web/libraries/html-javascript#commands).
