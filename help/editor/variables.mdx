...
To store user input in a variable, configure your **[User Input block](/help/editor/blocks/user-inputs/text)** to save the response. This variable can then be reused elsewhere in your Agent Dialog. For example:
