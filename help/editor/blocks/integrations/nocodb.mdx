...
| Action       | Step                                                                 |
|--------------|----------------------------------------------------------------------|
| Locate Table | Go to your dashboard and identify the table in the sidebar.          |
| Access ID    | Click the three dots and find the **Table ID** in the dropdown menu. |
...
The second image shows how this configuration looks in the Agent Dialog editor.
