...
title: Anthropic
---
The **Anthropic** Integration Block enables you to create and manage AI-driven messages in your bot using the **Claude AI** model. Below is a step-by-step guide to configuring and using this integration effectively.
