...
The **Image** Agent Dialog Block allows you to display an image to your users. This block supports various ways of adding images, providing flexibility and convenience.

<Frame style={{ maxWidth: '600px' }}>
  <img src="/help/images/blocks/agent-dialog/image.png" alt="Agent image blocks" />
</Frame>
