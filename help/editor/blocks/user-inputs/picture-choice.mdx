...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/help/images/blocks/inputs/picture-choice.png" alt="Agent Picture Choice block" />
</Frame>
---
...
- Upload images and assign title and description to represent options.
...
For advanced configuration, check out the [Buttons Choice](/help/editor/blocks/user-inputs/buttons-choice) block documentation. It works the same way