...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/help/images/blocks/inputs/buttons-choice.png" alt="Agent buttons choice block" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/help/images/blocks/inputs/buttons-multiple-choice.png" alt="Agent buttons multiple choice block" />
</Frame>
...
- Connect the "Other" button to a [Text](/help/editor/blocks/user-inputs/text) Input Block to collect custom input.
