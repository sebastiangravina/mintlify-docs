...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/help/images/blocks/inputs/phone.png" alt="Agent phone block" />
</Frame>
...
- **Prompt user**: Ask the user for the phone number using the text **[Agent Dialog Text block](/help/editor/blocks/agent-dialog/text)** (e.g., "Type your phone number...").  
