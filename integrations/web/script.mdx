...
### Recommendation
Whenever possible, prefer the **[HTML & JavaScript embed instructions](/deploy/web/libraries/html-javascript)** over the script embed method. Script snippets are merely scripts that inject code from the HTML & JavaScript embed method, offering limited control and customization.
