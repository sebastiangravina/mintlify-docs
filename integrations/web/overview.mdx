...
title:  Overview of embedding Release0 agents — standard, popup, and chat bubble options for your platform
description: Learn about embedding Release0 agents on your platform using standard, popup, or chat bubble methods. This guide provides an overview of the different embedding options available for your chatbot agents, including standard embed, popup embed, and chat bubble embed.
---
