...
To get the appropriate instructions to deploy your **agent** on your platform of choice, head over to the **Share** tab of your bot and select the platform you want to deploy your **agent** on.
...
- You can set the width to `100%` and the height to `100vh` to make it take up the entire page dimensions.
...
> **Note**: For each option, follow the detailed steps and customization instructions available in the **Share** tab of your bot.
...
For additional assistance, visit [release0.com](https://release0.com).
