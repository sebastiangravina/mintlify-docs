...
It will prefill the `Current URL` variable with "https://release0.com/account" and the `User name` variable with "John Doe". More info about variables: [here](../../../editor/variables.mdx).
