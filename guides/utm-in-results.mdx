...
title:  How to forward UTM parameters in Release0 to track campaigns and user sources in your chatbot
...
4. **Build a Redirect URL**:
   - Use the saved UTM values to construct a redirect URL in a **[Redirect Logic Block](/editor/blocks/logic/redirect)**. For example:
     ```url
