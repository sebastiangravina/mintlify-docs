...
description: Step-by-step guide to create your first agent in Release0, from setup to publishing. Learn how to use the flow editor, add elements, collect user input, and test your agent.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/guides/create-first-agent/text-element.gif" alt="Release0.com - Text element" />
</Frame>
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/guides/create-first-agent/input-element.gif" alt="Release0.com - Input element" />
</Frame>
