---
sidebarTitle: How to Create Your First Agent
title: How to create your first Agent in Release0
description: Step-by-step guide to create your first agent in Release0, from setup to publishing. Learn how to use the flow editor, add blocks, collect user input, and test your agent.
---
...
On the left side of your screen, you will see the **Blocks** panel. This is where you can add different types of blocks to your agent flow. You can choose from a variety of blocks, including:
