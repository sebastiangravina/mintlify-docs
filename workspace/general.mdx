...
It's your workspace unique slug on Release0. It is used to identify your workspace in the flow URL and they are also used as part of your agent public URL. The slug is automatically generated when you create a new workspace, but you can change it at any time.
...
> **Note**: If you hace a custom domain, the slug will not be used in the URL. The custom domain will be used instead.
