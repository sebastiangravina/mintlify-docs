...
title: Overview of Release0 workspaces
icon: building
description: Overview of Release0 workspaces, including settings, plans, and member management. This guide covers how to manage your workspace, including workspace name, slug, logo, and credentials. Learn how to add members, manage billing, and customize your workspace settings.
---
...
Most of the workspace settings can be accessed by selecting the workspace name from the dropdown in the top left corner of the dashboard, and then selecting **Settings**.
