...
The slug is used to access your workspace in the URL. For example, if your workspace slug is `my-slug`, you can access it at `https://app.r0.ar/my-slug/my-agent`.
...
For more detail on how to add a custom domain to your workspace, please see the [Custom Domain](/workspace/domains) documentation.
