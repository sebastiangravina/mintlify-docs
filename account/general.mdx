...
title: How to manage your account settings and preferences in Release0 across all workspaces
icon: 'user'
description: Manage your account settings and preferences across all workspaces. This guide covers how to access user settings, update your profile, manage notifications, and handle API keys.
---
