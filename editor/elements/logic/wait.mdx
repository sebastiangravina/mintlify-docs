---
sidebarTitle: Delay
title:  How to use the Delay element
icon: timer
description: The Delay element pauses conversations for a set duration, enhancing flow timing and emphasizing key points. Ideal for creating natural pacing in dialogues.
---
The **Delay** element allows you to pause the conversation for a set number of seconds. This feature can be used to:
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/logic/wait.png" alt="Release0.com - Delay logic elements" />
</Frame>


## Features of the **Delay** element
...
### 2. **Pause the Flow**
- Enabling **Pause the Flow** prevents agent from processing subsequent elements until the pause ends.
...
- **General Typing Speed Control**: Adjust this through **[Typing Emulation Settings](/theme/overview)**, not the **Delay** element.
