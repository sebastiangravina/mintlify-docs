...
title:  How to use the User Information element
icon: user-gear
description: Learn how to use the User Info element to collect network, location, device, and browser information while maintaining GDPR compliance and user privacy in your Release0 agents.
---
## Overview
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/logic/user-info.png" alt="Release0.com - User Info Agent elements" />
</Frame>
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/logic/user-info-details.png" alt="Release0.com - User Info Details Agent elements" />
</Frame>
