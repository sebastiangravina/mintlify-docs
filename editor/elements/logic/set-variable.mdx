...
title:  How to use the Set Variable element
icon: pen
description: The Set Variable element dynamically assigns, manipulates, and manages variables in workflows, enabling advanced operations and data transformations within your chatbot agent.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/logic/set-variable.png" alt="Release0.com - Set Variable Dialog elements" />
</Frame>
