...
title: How to use the Condition element
icon: code-branch
description: Understand how to use the Condition element to create decision points and logical paths in your agent flow.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/logic/condition.png" alt="Release0.com - Condition Agent elements" />
</Frame>
