...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/nocodb/nocodb-table-id.png" alt="Release0.com - NocoDB Table ID" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/nocodb/collect-data.png" alt="Release0.com - NocoDB Text element" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/nocodb/nododb-table.png" alt="Release0.com - NocoDB Table" />
</Frame>
...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/nocodb/create-order-connection.png" alt="Release0.com - NocoDB Create Record" />
</Frame>
...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/nocodb/save-records-nocodb.png" alt="Release0.com - NocoDB Create Record Configuration" />
</Frame>

Then we complete the records creation with a confirmation message.
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/integrations/nocodb/create-record.png" alt="Release0.com - NocoDB Confirmation Message" />
</Frame>

We can test this scenario by running the agent and entering the data. 

<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/nocodb/order-creation-test.png" alt="Release0.com - NocoDB Table Records" />
</Frame>

Once we have entered the data we can check the NocoDB table to see if the record was created.

<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/nocodb/nocodb-records.png" alt="Release0.com - NocoDB Table Records" />
</Frame>
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/integrations/nocodb/update-records-nocodb.png" alt="Release0.com - NocoDB Update Record" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/nocodb/order-creation-test1.png" alt="Release0.com - NocoDB Table Records" />
</Frame>

Update order by running the agent and entering the data.
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/integrations/nocodb/order-creation-test-agent.png" alt="Release0.com - NocoDB Update Record Configuration" />
</Frame>

After the update:
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/nocodb/order-creation-test2.png" alt="Release0.com - NocoDB Table Records" />
</Frame>
...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/nocodb/order-search-config.png" alt="Release0.com - NocoDB Search Record" />
</Frame>

Now we can check the data by running the agent and entering the data of the serial number to search for the order.
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/integrations/nocodb/order-search-test.png" alt="Release0.com - NocoDB Table Records" />
</Frame>
