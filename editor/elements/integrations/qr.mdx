...
description: Learn how to use the QR Code element to generate scannable codes for sharing links and information in your chatbot agent.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/integrations/qr-code/qrcode-setup.png" alt="Release0.com - QR Code Setup" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/qr-code/qr-code-sample.png" alt="Release0.com - QR Code Sample Flow" />
</Frame>
...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/qr-code/qr-code-agent.png" alt="Release0.com - QR Code Agent Sample" />
</Frame>