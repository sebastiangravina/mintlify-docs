...
description: Learn how to use the Pixel element to track user interactions and events with Meta Pixel in your chatbot agents.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images//elements/integrations/meta-pixel/meta-pixel-config.png" alt="Release0.com - Meta Pixel Integration" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
     <img src="/images/elements/integrations/meta-pixel/meta-pixel-events.png" alt="Release0.com - Meta Pixel Event Tracking" />
   </Frame> 
