...
description: Send events to Twilio’s Segment and trigger workflows using your chatbot agent. Learn how to configure the Segment element, find your Write Key, and use actions like Identify, Alias, Event, and Page.
---
...
<Frame style={{ maxWidth: '500px' }}>
  <img src="/images/elements/integrations/segment/segment-config.png" alt="Release0.com - Segment element configuration" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/segment/segment-flow-sample.png" alt="Release0.com - Segment element sample" />
</Frame>

Once configured, the Segment element will send the user information to Segment using the **Identify** action.

<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/integrations/segment/segment-agent-sample.png" alt="Release0.com - Segment element configuration sample" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/segment/segment-event.png" alt="Release0.com - Segment event response" />
</Frame>

If we check the source debugger, we can see the event details and the properties sent to Segment.

<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/segment/segment-source-debugger.png" alt="Release0.com - Segment debugger" />
</Frame>
