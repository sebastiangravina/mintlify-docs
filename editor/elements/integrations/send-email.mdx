...
description: Learn how to configure the Email element to send notifications and recap emails using SMTP providers.
---
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/elements/integrations/email/resend-api-key.png" alt="Release0.com - Resend API Key" />
</Frame>
Make sure you copy the API key, as you will need it in the next step.
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/email/resend-api-key-2.png" alt="Release0.com - Resend API Key" />
</Frame>
...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/email/resend-setup.png" alt="Release0.com - Resend SMTP Setup" />
</Frame>
...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/elements/integrations/email/smtp-setup-2.png" alt="Release0.com - Resend SMTP Setup" />
</Frame>
