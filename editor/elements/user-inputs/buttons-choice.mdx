...
title: How to use the Buttons Choice element
icon: arrow-pointer
description: Allow users to select predefined options with single or multiple-choice configurations and dynamic item lists in your chatbot agent.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/inputs/buttons-choice.png" alt="Release0.com - Agent buttons choice element" />
</Frame>
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/inputs/buttons-multiple-choice.png" alt="Release0.com - Agent buttons multiple choice element" />
</Frame>
