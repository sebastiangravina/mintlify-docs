...
title: Limit Agents flow access with Password element
icon: lock
description: The Password User Input element allows you to restrict access to parts of your agent flow by requiring users to enter a password. This is useful for protecting sensitive information or features within your chatbot.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/inputs/password-element.gif" alt="Release0.com - Agent password element" / >
</Frame>
...
1. **Add the Password Input element**:
   ...
   - Configure the **Prompt** to ask users for their password (e.g., "Please enter your password to continue").
    <Frame style={{ maxWidth: '600px' }}>
      <img src="/images/elements/inputs/password-element-drag.png" alt="Release0.com - Add Password input element" />
    </Frame>
2. **Configure the Password element**:
    ...
    - **Save Password in Variable**:
      ...
      <Frame style={{ maxWidth: '600px' }}>
        <img src="/images/elements/inputs/password-element-settings.png" alt="Release0.com - Configure Password input element" />
      </Frame>
