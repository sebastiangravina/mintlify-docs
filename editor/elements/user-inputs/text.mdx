---
sidebarTitle: Text
title: How to use the Text Input element
icon: text
description: Collect text-based responses from users with support for short text, long-form answers, and additional input types like password, file attachments, and audio recordings. This guide covers configuration options and use cases for effective user input collection.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/inputs/text-input.png" alt="Release0.com - Agent embed elements" />
</Frame>
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/inputs/allow-upload.png" alt="Release0.com - Allow Upload File element" />
</Frame>



<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/inputs/file-uploaded-sample.png" alt="Release0.com - Uploaded File Preview" />
</Frame>
