...
title: How to use the Play Audio element
icon: headphones
description: Learn how to use the Play Audio element to enhance user interactions with audio files or URLs.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/agent-dialog/audio.png" alt="Release0.com - Agent audio element" />
</Frame>
