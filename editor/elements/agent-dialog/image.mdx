...
title: How to use the Show Image element
icon: image
description: Discover how to use the Show Image element in Release0 to display pictures, GIFs, and stock images in your chatbot. This guide explains how to upload, link, and configure images to create engaging, visually rich conversations.
---
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/agent-dialog/image.png" alt="Release0.com - Agent Image elements" />
</Frame>
...
###
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/elements/agent-dialog/image.gif" alt="Release0.com - Image element" />
</Frame>
