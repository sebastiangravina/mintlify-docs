---
sidebarTitle: Graph
title: How to use the Graph in Release0 to map and edit chatbot flows visually
icon: game-board
description: Learn how to use the visual graph editor to design and manage conversational flows for your agents. Arrange blocks, connect them, and utilize gestures for efficient navigation in your chatbot development process."
---
