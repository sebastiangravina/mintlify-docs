---
sidebarTitle: Play Audio
title: How to use the Play Audio block in Release0 to add voice messages and sound clips to your chatbot agent
icon: headphones
description: Learn how to use the Play Audio block to enhance user interactions with audio files or URLs.
---

The **Play Audio** Agent Dialog Block allows you to play a recorded audio file for your users. This block supports both uploading audio files and pasting audio file URLs.

<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/blocks/agent-dialog/audio.png" alt="Release0.com - Agent audio block" />
</Frame>
...
Locate your audio file URL and paste it into the block.
