---
sidebarTitle: Blocks
title:  What are Blocks in Release0 and how to use them to build chatbot flows
description: Explore the fundamental components of an agent dialog, including user input, logic, integration, and AI blocks to create complex conversation flows in Release0.
---
