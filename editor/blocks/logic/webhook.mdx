...
title: Webhook Logic Block
icon: webhook
description: "The Webhook block pauses conversations while waiting for external system callbacks, ideal for handling long-running processes and API requests."
---
