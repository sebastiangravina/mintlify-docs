...
title: How to use the Webhook block in Release0 to send and receive data from external services in your chatbot agent
icon: webhook
description: The Webhook block pauses conversations while waiting for external system callbacks, ideal for handling long-running processes and API requests in your chatbot agent.
---
