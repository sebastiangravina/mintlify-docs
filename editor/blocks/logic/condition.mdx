...
title: How to use the Condition block in Release0 to create logic-based paths in your chatbot agent flow
icon: code-branch
description: Understand how to use the Condition block to create decision points and logical paths in your agent flow.
---
