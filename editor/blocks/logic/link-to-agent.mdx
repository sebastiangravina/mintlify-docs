...
title: How to use the Jump to Agent block in Release0 to link chatbot flows and share data between agents
icon: cube
description: The Jump to Agent block transitions workflows between agents, sharing variables and maintaining modular, reusable structures for complex chatbot interactions.
---
