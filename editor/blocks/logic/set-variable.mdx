...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/blocks/logic/set-variable.png" alt="Set Variable dialog blocks" />
</Frame>
...
### **Save in Results**
By default, variables are session-specific. Enabling this option will save the variable in the **[Results table](/results/overview)** for future reference.
