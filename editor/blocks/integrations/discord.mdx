...
<Frame style={{ marginLeft: '1.5rem', maxWidth: '70%' }}>
  <img
    src="/images/blocks/integrations/discord/discord-send-sumple-message.png"
...
Connect your flow to your Discord integration box and add text and variables to any of the discord messages types. Once the Agent chatbot flow reaches the Discord integration box, it will conenct to your discoed chanel and post the new message.
