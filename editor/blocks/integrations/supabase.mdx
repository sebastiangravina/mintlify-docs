...
title: How to integrate Release0 with Supabase to create, update, and query database records in your chatbot agent
...
Your project URL can be found in your Supabase dashboard under **Settings > Data Key**. It follows this format:
```
