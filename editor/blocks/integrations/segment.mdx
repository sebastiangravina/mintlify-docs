...
In the following example, we will configure the **Identify** action to send user information to Segment.
...
- Add the Segment block and select the **Identify** action.
...
When we run the scenario, the Segment block will send the user information to Segment using the **Identify** action.
