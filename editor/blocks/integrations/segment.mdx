...
title: How to integrate Release0 with Segment to track events and send user data for advanced analytics
...
### How to comfigure the Segment Block?
...
3. **Test the Block**:
   ...
   - You can use ther [Segment’s Debugger](https://segment.com/docs/connections/sources/debugger/) to validate the events sent.

In the following example, we will configure the **Track** action to send user information to Segment.

- Create a new block group and collet user data (Name, UserName, and Email)
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/blocks/integrations/segment/segment-source-debbuger.png" alt="Release0.com - Segment debugger" />
</Frame>
