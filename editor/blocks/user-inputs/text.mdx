---
sidebarTitle: Text
title: How to use the Text Input block
icon: text
...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/blocks/inputs/allow-upload.png" alt="Release0.com - Allow Upload File Block" />
</Frame>



<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/blocks/inputs/file-uploaded-sample.png" alt="Release0.com - Uploaded File Preview" />
</Frame>
