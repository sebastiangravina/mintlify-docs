...
title: Picture Choice User Input Block
icon: images
description: "Enable users to select options visually with customizable image-based choices in single or multiple selection formats."
---
