---
sidebarTitle: Picture Choice
title: How to use the Picture Choice block
icon: images
description: Enable users to select options visually with customizable image-based choices in single or multiple selection formats in your chatbot agent.
---
...
<Frame style={{ maxWidth: '400px' }}>
  <img src="/images/blocks/inputs/picture-choice.png" alt="Release0.com - Agent Picture Choice block" />
</Frame>
---
...
For advanced configuration, check out the [Buttons Choice](/editor/blocks/user-inputs/buttons-choice) block documentation. It works the same way and offers similar dynamic rendering capabilities with text-based buttons instead of images.