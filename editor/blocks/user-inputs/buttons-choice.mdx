...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/blocks/inputs/buttons-choice.png" alt="Agent buttons choice block" />
</Frame>
...
<Frame style={{ maxWidth: '800px' }}>
  <img src="/images/blocks/inputs/buttons-multiple-choice.png" alt="Agent buttons multiple choice block" />
</Frame>
