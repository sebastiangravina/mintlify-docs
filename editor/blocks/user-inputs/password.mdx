...
The **Password** User Input Block allows you to restrict access to parts of your agent flow by requiring users to enter a password. This is useful for protecting sensitive information or features within your chatbot. 

Unlike the [Password Agent Restriction](/editor/agent-settings/agent-password) that compelatelty prevents unauthorized users from accessing the agent, this block allows you to control access to specific flows or information within the agent.
