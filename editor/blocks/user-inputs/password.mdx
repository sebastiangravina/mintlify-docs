...
Unlike the [Password Agent Restriction](/editor/agent-settings/agent-password) that completely prevents unauthorized users from accessing the agent, this block allows you to control access to specific flows or information within the agent.
