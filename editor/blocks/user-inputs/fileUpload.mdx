...
Alternatively, you can allow your agent to collect images or documents using the **[Text User Input Block](./text)**. To do this, enable the **Allow attachments** toggle within the block settings.
<Frame style={{ maxWidth: '600px' }}>
