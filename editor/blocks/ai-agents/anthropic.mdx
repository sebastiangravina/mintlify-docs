...
title: How to integrate your agent with Anthropic
description: Step-by-step guide to configure and use the Anthropic Claude AI integration block for AI-driven messages.
---
...
```markdown
Hello! I’m a bot that showcases the new Claude AI integration block by Anthropic.  
