...
## Configure your Dify.AI Block

1. **Add new Dify.AI Block**: Select the **Dify.AI** block from the list of available blocks.
...
5. **Save your Block**: Click on the **Save** button to save your Dify.AI block configuration.

## Using the Dify.AI Block in your Agent Dialog
Once your Dify.AI block is configured, you can use it in your **Agent Dialog** to send messages to your Dify.AI assistant.
