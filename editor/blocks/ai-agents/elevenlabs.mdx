...
Once triggered, the ElevenLabs block will send a request to the ElevenLabs API with the specified parameters. The API will process the request and return a response containing the audio file URL.
