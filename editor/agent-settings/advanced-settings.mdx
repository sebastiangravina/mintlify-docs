...
Check out our blog post featuring a use case of how to use this feature to save session data in your agent to remmeber a user across sessions: [How to remember users across sessions](https://release0.com/blog/custom-session-auth-release0/).
