...
You can custom code to be included in the head of your agent. This code will be added at the buttom of the agent head section, just before the closing `</head>` tag. Only meta and script tags are allowed.
...
Check out our blog post featuring a use case of how to use this feature to save session data in your agent to remmeber a user across sessions: [How to remember users across sessions](https://release0.com/blog/release0-session-manager-guide/).
