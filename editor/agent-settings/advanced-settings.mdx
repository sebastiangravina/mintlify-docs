...
<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/agent-settings/agent-advanced-settings.png" alt="Access agent advanced settings" />
</Frame>

Then clik on **Advanced Settings**. This will open a new dialog displaying an additional set of options.

<Frame style={{ maxWidth: '600px' }}>
  <img src="/images/agent-settings/agent-advanced-settings-dialog.png" alt="Agent advanced settings Dialog" />
</Frame>
