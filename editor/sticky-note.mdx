...
icon: note
description: Learn how to use sticky notes in your flow editor to organize and annotate your chatbot flows effectively. This guide covers creating, editing, and managing sticky notes for better workflow visualization.
---
...
To edit an existing Sticky Note, simply right-click on the note you want to edit. This will open the editing Menu (Edit, Change Colour, Delete).
 - Change Colour: You can change the color of the sticky note to categorize or prioritize different notes. Click on the color option and select your desired color.
