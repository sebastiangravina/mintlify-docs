...
1. In the flow editor, click on the **Sticky Note** icon in the top right corner below variables icon. Thia will place a new sticky note in the center of your screen.
...
- Drag Sticky Notes behind blocks/grups. You can use this to visually group elements.
...
You can embed a Youtube video @[youtube](VIDEO-ID):
@[youtube](S6hfIxkdlRc)
```
