---
sidebarTitle: Agent Publication
title: How to publish an Agent in Release0 to make your chatbot live and accessible online
icon: globe
description: Step-by-step guide to publish your agent and make it accessible to the public in Release0. Learn how to configure your agent's public link, path, and name, and understand the importance of publishing for visibility and interaction.
---
